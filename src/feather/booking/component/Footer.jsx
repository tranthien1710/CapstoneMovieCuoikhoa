...
const Footer = () => {
  ...
  const listSchedule=useSelector(state=>state.booking.listScheduleCinema)
  return (
    <footer className="py-6 bg-[#141414] text-white ">
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            <a rel="noopener noreferrer" href="#" className="flex justify-center no-underline space-x-3 md:justify-start">
              <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                
              </div>
              <span className="self-center text-5xl font-semibold text-white  ">CyberSoft Movie</span>
            </a>
          </div>
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-medium text-white">Các bên liên quan</p>
           {listSchedule.map((item)=>{
            return <img className='mx-2' width={100} height={100} alt='' src={item.logo} />
           })}
          </div>
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-medium">Úng dụng</p>
